...
class Question extends Component {
  ...
  onChange = (current, pageSize) => {
    ...
    this.forceUpdate()
    axios
      .get(`http://172.25.0.12:5000/api/question?pageNo=${current}`)
      .then(response => {
  ...
  componentDidMount() {
    axios
      .get('http://172.25.0.12:5000/api/question/all')
      .then(response => {
        ...
        axios
        .get('http://172.25.0.12:5000/api/question?pageNo=1')
        .then(response => {
          this.json = response.data;
  ...
  onSubmitHandler = e => {
   // e.preventDefault();
    ...
    axios
      .post('http://172.25.0.12:5000/api/question/submit', { newArray })
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Countdown date={this.currentTime + 600000} onComplete={this.onSubmitHandler} />

        {this.json.length>0?(<div>
